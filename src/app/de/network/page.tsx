...
const network = ["Private Sammler", "Haendler & Spezialisten", "Private Kunden", "Family Offices & Industriepartner"];

export const metadata: Metadata = {
  title: "Netzwerk | The Circle Twelve",
  description: "Das Netzwerk von The Circle Twelve verbindet Eigentuemer, qualifizierte Kaeufer und vertraute internationale Partner.",
      ...
      <section className="relative min-h-[72svh] overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[72svh] max-w-[96rem] flex-col justify-end px-5 pb-14 pt-32 sm:px-8 lg:px-12 lg:pb-20">
          ...
          <p className="mt-8 max-w-3xl text-lg leading-8 text-[#d8d0c2] sm:text-xl sm:leading-9">
            The Circle Twelve arbeitet ueber direkte Beziehungen, vertraute Einfuehrungen und sorgfaeltig qualifizierte Gelegenheiten.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#f0e7d6] px-5 py-10 text-[#16110b] sm:px-8 lg:px-12">
        <div className="mx-auto max-w-[96rem]">
          <p className="max-w-4xl text-xl font-medium leading-9 text-[#21180f]">
            Wir beschaffen aussergewoehnliche Assets fuer private Kunden und verbinden Eigentuemer mit qualifizierten Kaeufern ueber ein internationales Netzwerk, das mit der Zeit gewachsen ist.
          </p>
        </div>
      </section>
